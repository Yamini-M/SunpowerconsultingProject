...
/**
 * Created by manasal on 29/06/16.
 */
public class SecureSharedPreferences {

    public static String KEY_LOGIN_ID = "LoginId";
    public static String KEY_PASSWORD = "LoginPassword";

    public static class SecureSharedPreferencesException extends RuntimeException {

        public SecureSharedPreferencesException(Throwable e) {
            super(e);
        }
    ...
    /**
     * This will initialize an instance of the SecureSharedPreferences class
     *
     ...
     * @throws SecureSharedPreferencesException
     */
    public SecureSharedPreferences(Context context, String preferenceName, String secureKey, boolean encryptKeys) throws SecureSharedPreferencesException {
        try {
    ...
    public String getString(String key) throws SecureSharedPreferencesException {
    ...
    private void putValue(String key, String value) throws SecureSharedPreferencesException {
        String secureValueEncoded = encrypt(value, writer);

        preferences.edit().putString(key, secureValueEncoded).commit();
    }

    protected String encrypt(String value, Cipher writer) throws SecureSharedPreferencesException {
        byte[] secureValue;
        try {
    ...
    private static byte[] convert(Cipher cipher, byte[] bs) throws SecureSharedPreferencesException {
        try {
    ...
    public boolean isLoggedIn(){
       return !TextUtils.isEmpty(getString(KEY_LOGIN_ID));
    }
}
